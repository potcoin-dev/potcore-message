...
Potcore implementation of [potcoin message signing and verification](http://potcoin.stackexchange.com/questions/3337/what-are-the-safety-guidelines-for-using-the-sign-message-feature/3339#3339). This is used to cryptographically prove that a certain message was signed by the holder of an address private key.

For more information refer to the [potcore-message](https://github.com/potcoin-dev/potcore-message) github repo.
...
```bash
npm install potcore-message --save
```

For client-side projects:

```bash
bower install potcore-message --save
```
